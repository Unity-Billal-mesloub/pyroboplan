...
[![PyRoboPlan Tests](https://github.com/Unity-Billal-mesloub/pyroboplan/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/Unity-Billal-mesloub/pyroboplan/actions/workflows/tests.yml)
...
This library extensively uses the [Pinocchio](https://github.com/Unity-Billal-mesloub/pinocchio) Python bindings for modeling robot kinematics and dynamics.
...
> If you are doing more serious motion planning and control work, check out [RoboPlan](https://github.com/Unity-Billal-mesloub/roboplan).
...
```bash
git clone https://github.com/Unity-Billal-mesloub/pyroboplan.git
```
